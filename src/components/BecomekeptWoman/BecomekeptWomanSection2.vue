...
<!--          minimize your costs and improve your execution.</p>-->
    ...
    <div class="section-alpha">
      ...
      <div class="section-2">
        ...
        <img src="https://luxury-girls-monaco.com/wp-content/uploads/2021/06/Russian-escort-models-in-Monaco.jpg" alt="image" class="image" />
      ...
      <div class="section-1">
        ...
        <div class="text-part">
          <div class="lawrence">
            ...
            <p class="text-1">BUDGET FROM $10,000 PER WEEK</p>
          </div>
<!--          <p class="text-2">Create your account today and unlock the full potential of our services.</p>-->
        ...
        <div class="text-part">
          <div class="lawrence">
            <img src="@/assets/pointer.svg" alt="pointer" class="pointer">
            <p class="text-1">Relationship with a successful and generous man</p>
          </div>
<!--          <p class="text-2">Verify your account to unlock full access and kickstart your journey with us.</p>-->
        ...
        <div class="text-part">
          <div class="lawrence">
            <img src="@/assets/pointer.svg" alt="pointer" class="pointer">
            <p class="text-1">Beautiful life, expensive gifts, personal funds for luxury brands</p>
          </div>
<!--          <p class="text-2">Select the perfect investment plan and embark on your journey to financial success.</p>-->
        ...
        <div class="text-part">
          <div class="lawrence">
            <img src="@/assets/pointer.svg" alt="pointer" class="pointer">
            <p class="text-1">Enjoying life, no financial restrictions</p>
          </div>
<!--          <p class="text-2">Deposit into your investment account and watch your Profits grow.</p>-->
        ...
        <div class="text-part">
          <div class="lawrence">
            <img src="@/assets/pointer.svg" alt="pointer" class="pointer">
            <p class="text-1">Opportunity to choose from the best sponsors from around the world</p>
          </div>
          <!--          <p class="text-2">Create your account today and unlock the full potential of our services.</p>-->
        </div>
        ...
        <div class="text-part">
          <div class="lawrence">
            <img src="@/assets/pointer.svg" alt="pointer" class="pointer">
            <p class="text-1">Chance to find a life partner and successfully marry</p>
          </div>
          <!--          <p class="text-2">Create your account today and unlock the full potential of our services.</p>-->
        </div>
